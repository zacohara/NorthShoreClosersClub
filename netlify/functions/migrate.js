...
export default async (req) => {
  const cs = Buffer.from('cG9zdGdyZXNxbDovL3Bvc3RncmVzLndrcnRianZiamViaGJjand1cmhiOkRpZWdvRGFrb3RhMzc0MiFAYXdzLTAtdXMtZWFzdC0xLnBvb2xlci5zdXBhYmFzZS5jb206NjU0My9wb3N0Z3Jlcw==', 'base64').toString();
  ...
  try {
    ...
    await client.end();
    return new Response(JSON.stringify({ success: true, message: 'weekly_digests table created with RLS policies and indexes' }), {
