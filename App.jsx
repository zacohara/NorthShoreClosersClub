...
import { loadAllProgress, saveQuizResult, loadAnalyses, saveAnalysis, loadLatestDigest, loadAllAnalyses, loadProfile, loadAllProfiles, saveProfile, updateStreak } from "./supabase.js";
        ...
        <div style={{position:"relative",overflow:"hidden",background:C.navy}}>
          ...
          <div style={{position:"relative",padding:"28px 24px 24px",maxWidth:960,margin:"0 auto"}}>
            ...
            <div style={{display:"flex",gap:10,flexWrap:"wrap",marginTop:8}}>
              ...
              {streak.current > 0 && <StatPill label="Streak" value={`${streak.current}d ${streak.current>=14?'🔥🔥🔥':streak.current>=7?'🔥🔥':streak.current>=3?'🔥':''}`}/>}
              {currentBadge && <StatPill label="Badge" value={currentBadge.label}/>}
