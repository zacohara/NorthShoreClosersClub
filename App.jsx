...
import { loadAllProgress, saveQuizResult, loadAnalyses, saveAnalysis, loadLatestDigest, loadAllAnalyses } from "./supabase.js";
...
const ICON = "data:image/png;base64,";
const BG = "data:image/jpeg;base64,";
...
export default function App() {
  ...
  useEffect(() => {
    if (user) loadLatestDigest(user).then(d => setDigest(d)).catch(() => {});
    else setDigest(null);
  }, [user]);
        ...
        <div style={{flex:1,maxWidth:420,margin:"0 auto",padding:"28px 20px",width:"100%"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {USERS.map(u => {
              ...
              const done = pc === 15;
              return (
                <button key={u} onClick={() => { setUser(u); setScreen("home"); }}
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:12}}>
                    <div style={{width:40,height:40,borderRadius:10,background:C.navy,color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:800}}>
                      {u[0]}
                    </div>
      ...
      <div style={{minHeight:"100vh",background:C.bg,fontFamily:"'Outfit',sans-serif"}}>
          ...
          <div style={{position:"relative",padding:"28px 24px 24px",maxWidth:960,margin:"0 auto"}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                <img src={ICON} alt="" style={{width:44,height:44,borderRadius:10,padding:2}}/>
                <div>
              ...
              <button onClick={() => { loadAllProgress().then(d => setAllProg(d)); setUser(null); setScreen("login"); }}
            ...
            <div style={{display:"flex",gap:10,flexWrap:"wrap",marginTop:8}}>
              ...
              <StatPill label="Accuracy" value={totalAns > 0 ? `${Math.round(totalRight/totalAns*100)}%` : "—"}/>
              {allPassed && <StatPill label="Status" value="🏆 Certified"/>}
            </div>
          </div>
        </div>
        ...
        <div style={{maxWidth:960,margin:"0 auto",padding:"16px 16px 24px"}}>
          ...
          {digest && digest.active && (
            <div style={{background:C.navy,borderRadius:12,padding:"16px 18px",marginBottom:16,position:"relative",overflow:"hidden"}}>
              <div style={{position:"absolute",inset:0,backgroundImage:`url(${BG})`,backgroundSize:"cover",backgroundPosition:"center",opacity:0.1}}/>
              <div style={{position:"relative"}}>
                  ...
                  <div style={{display:"flex",gap:8}}>
                    ...
                    {digest.analyses_this_week > 0 && (
                      <div style={{textAlign:"center",background:"rgba(255,255,255,0.08)",borderRadius:8,padding:"6px 12px"}}>
                        ...
                        <div style={{fontSize:9,color:"rgba(255,255,255,0.5)"}}>calls analyzed</div>
                      </div>
                    )}
                    {digest.accuracy > 0 && (
                      <div style={{textAlign:"center",background:"rgba(255,255,255,0.08)",borderRadius:8,padding:"6px 12px"}}>
        ...
        <div style={{maxWidth:700,margin:"0 auto",padding:"20px 16px 48px"}}>
          ...
          <div style={{background:C.navy,borderRadius:12,padding:"18px",marginBottom:16,position:"relative",overflow:"hidden"}}>
            ...
            <div style={{position:"relative"}}>
              ...
              <div style={{color:"rgba(255,255,255,0.55)",fontSize:12,lineHeight:1.5}}>Paste your Plaud transcript. AI analyzes against all 7 Sandler submarine steps.</div>
            </div>
          </div>
          ...
          <div style={{background:C.card,borderRadius:12,padding:"16px",border:`1px solid ${C.bdr}`,marginBottom:14}}>
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:8}}>
              ...
              <button onClick={analyzeTranscript} disabled={bsAnalyzing || bsTranscript.trim().length < 50} className="btn-primary"
                ...
                {bsAnalyzing ? "Analyzing..." : "Analyze Call"}
              </button>
            </div>
          </div>
          ...
          {bsAnalyzing && (
            <div style={{background:C.card,borderRadius:12,padding:"24px",border:`1px solid ${C.bdr}`,textAlign:"center",marginBottom:14,animation:"fadeIn 0.3s ease"}}>
              ...
              <div style={{fontSize:14,fontWeight:700,color:C.dk,marginBottom:2}}>Running Sandler analysis...</div>
              <div style={{fontSize:11,color:C.mut}}>Evaluating all 7 submarine steps. 10-20 seconds.</div>
            </div>
          )}
